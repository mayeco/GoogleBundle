            ...
            ->children()
                ...
                ->arrayNode('oauth_info')
                    ...
                    ->children()
                        ...
                        ->scalarNode('access_type')->isRequired()->cannotBeEmpty()->defaultValue('offline')->end()
                        ->scalarNode('approval_prompt')->isRequired()->cannotBeEmpty()->defaultValue('force')->end()
                    ->end()
                ->end()
                ->arrayNode('adwords')
                    ->isRequired()
                    ...
                    ->children()
                        ...
                        ->scalarNode('lib_version')->isRequired()->cannotBeEmpty()->defaultValue('v201409')->end()
                    ->end()
                ->end()
            ->end()
        ;
